...
use App\Models\MstJobPositions as Model;
use App\Http\Resources\JobPositionResource as ModelResource;

class JobPositionsController extends BaseController
{
    private $module = 'Job Position';
